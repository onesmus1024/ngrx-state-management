...
const routes: Routes = [
  ...
  {path:"profile", loadComponent:()=>import('./user/user.component').then(c=>c.UserComponent),
  children:[
    {path:'updateUser', loadComponent:()=>import('./user/update-user/update-user.component').then(c=>c.UpdateUserComponent)}]
  },
